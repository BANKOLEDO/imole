...
async function initSchema() {
  ...
  await pool.query('ALTER TABLE parents ADD COLUMN IF NOT EXISTS password TEXT')
  await pool.query('ALTER TABLE parents ALTER COLUMN password DROP NOT NULL')
  ...
  await pool.query('ALTER TABLE teachers ALTER COLUMN password DROP NOT NULL')
